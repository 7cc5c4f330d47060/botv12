...
3. Download the version of minecraft-data with 26.1 protocol support. This can be done with Git by running: `git clone -b pc_1_21_11 https://github.com/PrismarineJS/minecraft-data --depth 1`. <!-- From old NMP CI, may not be 100% accurate, as it is likely vibe coded and generated by AI. -- >
