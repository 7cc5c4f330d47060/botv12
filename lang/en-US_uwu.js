...
export default {
  ...
  strings: {
    ...
    'command.list.intro.v2proto': '%s %s, with %s currently vanished.', // not used
    ...
    'command.music.loop.on': 'Enabwed wooping',
    'command.music.loop.off': 'Disabwed wooping',
    'command.music.pitchShiftSet': 'Set pitch shift to %s semitones',
    'command.music.speedSet': 'Set speed to %s',
    'command.music.volumeSet': 'Set vowume to %s',
    'command.music.gotoTime': 'Set time to %s',
    'command.music.queueIntro': 'Queue (%s)',
    'command.music.queueItem': '%s - %s',
    'command.music.error.notPlaying': 'No song is cuwwentwy pwaying',
    'command.music.error.neverPlayed': 'No songs have been pwayed in this session',
    'command.music.restartCurrent': 'Westawting cuwwent twack',
    'command.music.restartPrevious': 'Westawting pwevious twack',
    'command.music.paused': 'The music is now paused',
    'command.music.unpaused': 'The music is now pwaying',
    'command.netmsg.serverAddress': 'Sewvew Addwess',
    'command.scale.set': 'Set pwayew size to %s',
    'command.scale.reset': 'Weset pwayew size',
    'command.seen.success': '%s was wast seen on %s, and has joined %s %s.',
    'command.seen.success.time': 'time',
    'command.seen.success.timePlural': 'times',
    'command.seen.neverSeen': '%s has nevew been seen',
    'command.test.uuid': 'UUID',
    'command.test.username': 'Usewnyame',
    'command.test.nickname': 'Nicknyame',
    'command.test.command': 'Command',
    'command.test.msgType': 'Message type',
    'command.test.msgSubtype': 'Message subtype',
    'command.test.prefix': 'Pwefix',
    'command.test.args': 'Awguments',
    'command.test.verify': 'Pewmission wevew',
    'command.test.host': 'Sewvew host',
    'command.test.port': 'Sewvew port',
    'command.test.lang': 'wanguage',
    'command.test.colorPrimary': 'Pwimary color', // Not used, yes i started before realizing.
